...
$(document).ready(function () {
    ...
    function indicatorClicked(direction, targetIndex) {
        ...
        carouselIndicators.find(`[data-order="${targetIndex}"]`).removeClass('active');
        ...
        setTimeout(function () {
            ...
            // Add the active class to the new indicator again
            carouselIndicators.find('.active').addClass('active');
        }, 800);
    }
